...
mod test {
    ...
    fn ensure_env_var_config() {
        let values = [
            ...
            (
                "RPC_PROXY_PROVIDER_COINBASE_API_KEY_ID",
                "COINBASE_API_KEY_ID",
            ),
            (
                "RPC_PROXY_PROVIDER_COINBASE_API_KEY_SECRET",
        ...
        assert_eq!(
            ...
            Config {
                ...
                providers: ProvidersConfig {
                    ...
                    coinbase_api_key_id: Some("COINBASE_API_KEY_ID".to_owned()),
                    coinbase_api_key_secret: Some("COINBASE_API_KEY_SECRET".to_owned()),
