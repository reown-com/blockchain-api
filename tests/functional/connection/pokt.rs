...
// TODO: find new provider for solana - POKT currently is throwing internal
// server error for this #[test_context(ServerContext)]
// #[tokio::test]
...
//     let client = Client::builder().build::<_,
// hyper::Body>(HttpsConnector::new());     let request = jsonrpc::Request {
//         method: "getHealth",
//         params: &[],
//         id: serde_json::Value::Number(1.into()),
//         jsonrpc: JSONRPC_VERSION,
