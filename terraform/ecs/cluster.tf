  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "RPC_PROXY_PROVIDER_COINBASE_API_KEY_ID", value = var.coinbase_api_key_id },
        { name = "RPC_PROXY_PROVIDER_COINBASE_API_KEY_SECRET", value = var.coinbase_api_key_secret },
