...
.addPanels(layout.generate_grid([
  ...
  row.new('Chain Usage'),
    panels.usage.provider(ds, vars, 'Infura')        { gridPos: pos._3 },
    panels.usage.provider(ds, vars, 'zkSync')        { gridPos: pos._3 },
    panels.usage.provider(ds, vars, 'Publicnode')    { gridPos: pos._3 },
